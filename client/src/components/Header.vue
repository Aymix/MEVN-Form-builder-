          ...
          <router-link class="navbar-brand f-w-500" to="/">Form Builder*</router-link>
            <div v-if="!$store.state.auth.status.loggedIn" class="d-flex">
                <ul class="navbar-nav me-auto mb-2  mb-lg-0">
                    <li class="nav-item">
                        <router-link class=" f-w-500 nav-link" to="/">Home</router-link>
                    </li>
                    <li class="nav-item">
            ...
            <div v-if="$store.state.auth.status.loggedIn" class="d-flex">
                <ul class="navbar-nav me-auto mb-2  mb-lg-0">
                    <li class="nav-item">
                        <router-link class="f-w-500 nav-link" to="/dashboard/pages">Pages</router-link>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item d-flex align-items-center">
                        <div v-if="loggedIn">
                            <button @click="logOut" class="logout btn btn-primary ms-3">
